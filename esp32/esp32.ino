...
#define TOPICO_SUBSCRIBE    "/TEF/lamp0002/cmd"        //tópico MQTT de escuta
#define TOPICO_PUBLISH      "/TEF/lamp0002/attrs"      //tópico MQTT de envio de informações para Broker
#define TOPICO_PUBLISH_2    "/TEF/lamp0002/attrs/l"    //tópico MQTT de envio de informações para Broker
                                                      //IMPORTANTE: recomendamos fortemente alterar os nomes
                                                      //            desses tópicos. Caso contrário, há grandes
                                                      //            chances de você controlar e monitorar o ESP32
                                                      //            de outra pessoa.
#define ID_MQTT  "fiware_0002"      //id mqtt (para identificação de sessão)
